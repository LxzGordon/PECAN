...
expert_trajs = get_trajs_from_data(DEFAULT_DATA_PARAMS['data_path'],['random3'],True,False)

# Load the expert dataset
save_npz_file(expert_trajs, "random3.npz")
...
class ImitationAgentFromPolicy(AgentFromPolicy):
    ...
    def set_context(self,context:np.array):
        self.context=context
        
    def action(self, state,c=None):
